...
if( !function_exists( 'otw_tgsw_init' ) ){
	...
	function otw_tgsw_init(){
		...
		$otw_tgsw_shortcode_object->shortcodes['content_toggle'] = array( 'title' => __('Content toggle', 'otw_tgsw'),'enabled' => true,'children' => false, 'parent' => false, 'order' => 8,'path' => dirname( __FILE__ ).'/otw_components/otw_shortcode/', 'url' => $otw_tgsw_plugin_url.'include/otw_components/otw_shortcode/', 'dialog_text' => $otw_tgsw_dialog_text  );
		...
		$otw_tgsw_factory_object->add_plugin( $otw_tgsw_plugin_id, dirname( dirname( __FILE__ ) ).'/otw_content_manager.php', array( 'menu_parent' => 'otw-tgsw-settings', 'lc_name' => __( 'License Manager', 'otw_tgsw' ), 'menu_key' => 'otw-tgsw' ) );
...
if( !function_exists( 'otw_tgsw_init_admin_menu' ) ){
	...
	function otw_tgsw_init_admin_menu(){
		...
		add_menu_page(__('Toggles Shortcode And Widget', 'otw_tgsw'), __('Toggles Shortcode And Widget', 'otw_tgsw'), 'manage_options', 'otw-tgsw-settings', 'otw_tgsw_settings', $otw_tgsw_plugin_url.'images/otw-sbm-icon.png');
		add_submenu_page( 'otw-tgsw-settings', __('Settings', 'otw_tgsw'), __('Settings', 'otw_tgsw'), 'manage_options', 'otw-tgsw-settings', 'otw_tgsw_settings' );
