...
$message = '';
$massages = array();
$messages[1] = __( 'Settings saved', 'otw_tgsw' );
...
<div class="wrap">
	...
	<h2>
		<?php _e('Plugin Settings', 'otw_tgsw') ?>
	</h2>
		...
		<form method="post" action="" class="validate">
			...
			<div id="post-body">
				...
				<div class="form-field">
					<label for="otw_cm_promotions"><?php _e('Show OTW Promotion Messages in my WordPress admin', 'otw_tgsw'); ?></label>
				...
				<p class="submit">
					<input type="submit" value="<?php _e( 'Save Settings', 'otw_tgsw') ?>" name="submit" class="button"/>
				</p>
			</div>
		</form>
	</div>
